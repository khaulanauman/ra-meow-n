...
export default function gamePage() {
  return (
    ...
    >
      <div className="border-2 border-red-500 utensils min-h-screen bg-red-100 p-4 rounded-md">
      ...
      <div className="main border-2 border-red-500">
      ...
      <div className="ingredients min-h-screen border-2 border-red-500  bg-white p-4 rounded-md">
